...
const shopLinks = [
  ...
  { href: '/products?category=packs', label: 'Bundles' },
  { href: '/products?category=limited', label: 'Gift Sets' },
...
export default function Footer() {
  return (
    <footer className="bg-coke-black text-white">
        ...
        <div className="section-max-width">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
            ...
            <div>
              ...
              <p className="mt-3 text-sm text-neutral-400 leading-relaxed">
                Open Happiness. The world&apos;s most iconic beverage, bringing people together since 1886.
              </p>
          ...
          <div className="mt-16 pt-8 border-t border-neutral-800 flex flex-col sm:flex-row items-center justify-between gap-4">
            <p className="text-xs text-neutral-500">
              &copy; 2026 The Coca-Cola Company. All rights reserved.
            </p>
